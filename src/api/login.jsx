...
export const KAKAO_AUTH_URL = `https://kauth.kakao.com/oauth/authorize?client_id=7e752663661fc807285cb45197bef9d5&redirect_uri=http://localhost:3000/login/oauth2/kakao1&response_type=code`;
